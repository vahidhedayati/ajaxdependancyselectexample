<g:javascript>
	...
	function ${attrs.id}Reload(value) {
		
			var zselect = document.getElementById('${attrs.showId}')
			var zselect2= $('#${attrs.id}').attr('bindValue');
			alert('---'+zselect.value+' 2 ---'+zselect2)
	}
	

 	function ${attrs.id}Update2(e) { 
  		if (e) { 	
