		...
		<div id="show-myBorough" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${myBoroughInstance?.id}" />
					<g:link class="edit" action="edit" id="${myBoroughInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
