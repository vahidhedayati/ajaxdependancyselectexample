		...
		<div id="show-myCountry" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${myCountryInstance?.id}" />
					<g:link class="edit" action="edit" id="${myCountryInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
