		...
		<div id="show-myCity" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${myCityInstance?.id}" />
					<g:link class="edit" action="edit" id="${myCityInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
