		...
		<div id="show-streets" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${streetsInstance?.id}" />
					<g:link class="edit" action="edit" id="${streetsInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
